...
(function (ng, undefined) {
    ...
    ng.module('smart-table')
        .controller('stTableController', ['$scope', '$parse', '$filter', '$attrs', function StTableController($scope, $parse, $filter, $attrs) {
            ...
            //var datesFilter = $filter('filterDateRange');
            ...
            this.search = function search(input, predicate) {
                ...
                //tableState.search.isRangeSearch = isRangeSearch;
            ...
            this.pipe = function pipe() {
                ...
                if (tableState.search.predicateObject) {
                    ...
                    //if(tableState.search.isRangeSearch !== undefined && tableState.search.isRangeSearch)
                    //    filtered = datesFilter(safeCopy, tableState.search.predicateObject)
                    //else
                        filtered = filter(safeCopy, tableState.search.predicateObject);
                } else {
                    // if no predicateObject, then don't filter
                    filtered = safeCopy;
                }

                // irrelevant to search
