    ...
    angular.module('ngBootstrap', []).directive('input', function ($compile, $parse) {
        return {
            ...
            link: function ($scope, $element, $attributes, ngModel) {
                ...
                var options = {};
                options.format = $attributes.format || 'MM DD YYYY';
                ...
                // HACKFIX - eval an object incoming from the HTML side. Can we modify the attributes from the outside without the hack?!?!?!
                options.ranges = eval($attributes.ranges);
                ...
                $scope.$watch($attributes.ngModel, function (modelValue) {
                    //console.log("SCOPE WATCH: " + modelValue);

                    // HACK-FIX: if the object retreived is of type string (WHY is it passed here in the first place????? DEBUG!!), ignore.
