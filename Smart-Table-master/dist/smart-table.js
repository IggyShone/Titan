...
(function (ng, undefined) {
    ...
    ng.module('smart-table')
        .controller('stTableController', ['$scope', '$parse', '$filter', '$attrs', function StTableController($scope, $parse, $filter, $attrs) {
            ...
            //var converter = function(predicateObject){
            //
            //    var myprop = predicateObject[prop]
            //    exp = null
            //    foreach (predicate in predicateObject.predicates) {
            //        exp +=predicateObject[prop].toLowerCase() == predicate
            //    }
            //    return exp
            //
            //}
